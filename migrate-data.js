...
const ALL_EXERCISES = [
  ...
  { id: 'ex-cambered-bar-pushdowns', name: 'Cambered Bar Tricep Pushdowns', bodyPartGroup: 'arms', equipment: 'cable', machineId: null, unit: 'lbs', isTimed: false, isUnilateral: false, isBodyweight: false, notes: 'Cambered/EZ-curl bar attachment — not the rope.', variationGroupId: 'grp-triceps', variationBase: 'Triceps', variationLabel: 'Cambered Bar' },
