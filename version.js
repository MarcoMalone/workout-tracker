...
export const CHANGELOG = [
  {
    ...
    date: '2026-09-08',
    items: [
      'Fixed reordering not sticking — dragging exercises to a new order and tapping Done now actually saves the new order (the drop wasn\'t always registering on touch).',
    ],
  },
  {
    v: '1.7.31',
  ...
  },
  {
    ...
    date: '2026-08-28',
    items: [
      'New Running Efficiency section on the Progress tab — your aerobic efficiency (distance per heartbeat) and cadence trending over recent runs, so you can see fitness improving even when your pace looks the same.',
    ],
  },
  {
    v: '1.7.29',
  ...
  },
  {
    ...
    date: '2026-08-27',
    items: [
      'The Coach can now see your runs. Your recent runs (pace, heart rate, cadence, and whether you faded) feed into the pre-workout Coach, and every run has a new "Coach debrief" button for specific feedback on that run.',
    ],
  },
  {
    v: '1.7.23',
    date: '2026-08-27',
    items: [
      'Fixed reordering exercises: dragging to reorder — both mid-workout and in the template editor — no longer glitches or jumps on touch. The list now moves smoothly under your finger.',
    ],
  },
  {
    v: '1.7.22',
