...
const PRECACHE = [
  ...
  'onboarding.js', 'metrics.js', 'seed-data.js', 'migrate-data.js', 'rotation.js', 'variations.js', 'template-reorder.js', 'icons.js', 'strava-client.js', 'strava.js', 'ui-strava.js', 'manifest.json',
